...
const JOURNEYS = {
  ...
  [FATES.PAPER]: [
    ...
    { t: 'day 6', title: 'The sorting line', branch: true, text: 'Grease is the killer. Oil-soaked fibre cannot be pulped, and one greasy item can downgrade an entire bale around it.' },
  ...
  [FATES.TOXIC]: [
    ...
    { t: 'the better road', title: 'What should have happened', text: 'Take-back points sit in most supermarkets and electronics shops. It costs one trip you were making anyway.' },
  ],
  [FATES.TEXTILE]: [
...
export const ITEMS = [
  ...
  },
  {
    ...
    harm: 'The ear loops are the real problem — small animals and birds get tangled in them. Cleanup groups now find masks on essentially every beach survey.',
  ...
  },
  {
    ...
    better: 'Supermarket collection boxes. You walk past one most weeks.',
    recycle: 'Yes, and it genuinely matters — but only via a take-back point, never a kerbside bin.',
  },
  {
  ...
  },
  {
    ...
    harm: 'Handle, bristles and grip are three different plastics moulded together and impossible to separate. Essentially every toothbrush you have ever used still exists somewhere.',
  ...
  },
  {
    ...
    harm: 'The cardboard is fine. The grease is not — oil cannot be pulped out, and a soaked box downgrades everything baled with it.',
    better: 'Tear off the clean lid and recycle that. Bin the greasy base. Five seconds, and it genuinely matters.',
    recycle: 'The clean half only.',
  },
  {
